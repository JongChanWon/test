...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
	...
	<a href="index3.html" class="brand-link"> <img
		src="${IMG_PATH}/AdminLTELogo.png" alt="AdminLTE Logo"
	...
	<div
		...
		<div class="os-content-glue"
			style="margin: 0px -8px; width: 249px; height: 804px;"></div>
			...
			<div class="os-viewport os-viewport-native-scrollbars-invisible"
				...
				<div class="os-content"
					...
					<div class="user-panel mt-3 pb-3 mb-3 d-flex">
						<div class="image">
							<img src="${IMG_PATH}/user2-160x160.jpg"
		...
		<div
			...
			<div class="os-scrollbar-track">
				<div class="os-scrollbar-handle"
					style="height: 63.429%; transform: translate(0px, 0px);"></div>
			</div>
		</div>
