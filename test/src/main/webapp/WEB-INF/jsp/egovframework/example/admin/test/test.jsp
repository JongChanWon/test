		...
		<table class="table table-striped projects">
			...
			<tbody>
				<tr>
					...
					<td>
						<ul class="list-inline">
							<li class="list-inline-item"><img alt="Avatar"
								class="table-avatar" src="${IMG_PATH}/avatar.png"></li>
							<li class="list-inline-item"><img alt="Avatar"
								class="table-avatar" src="${IMG_PATH}/avatar2.png"></li>
							<li class="list-inline-item"><img alt="Avatar"
								class="table-avatar" src="${IMG_PATH}/avatar3.png"></li>
							<li class="list-inline-item"><img alt="Avatar"
								class="table-avatar" src="${IMG_PATH}/avatar4.png"></li>
						</ul>
					</td>
					...
					<td class="project-state"><span class="badge badge-success">Success</span>
					</td>
					...
					<td>
						<ul class="list-inline">
							...
							<li class="list-inline-item"><img alt="Avatar"
								class="table-avatar" src="${IMG_PATH}/avatar4.png"></li>
							<li class="list-inline-item"><img alt="Avatar"
								class="table-avatar" src="${IMG_PATH}/avatar5.png"></li>
						</ul>
					</td>
					<td class="project_progress">
						<div class="progress progress-sm">
